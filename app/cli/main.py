...
from app.domain.discounts import DISCOUNT_TYPES, build_discount
from app.domain.exceptions import RideHailingError
from app.domain.models import CarType, Location
...
def main(argv=None) -> int:
    ...
    from app.storage.postgres import SchemaOutOfDateError, apply_schema, open_pool, postgres_repositories
    try:
